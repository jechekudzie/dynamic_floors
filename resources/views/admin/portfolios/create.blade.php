        ...
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                <form action="{{url('/admin/portfolios')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <h4 class="title">About Portfolio</h4>

                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30"><input name="title" class="form-control" type="text"
                                                                  placeholder="Portfolio name*"></div>
                        <div class="col-12 mb-30"><textarea name="description" class="summernote form-control"
                                                            placeholder="Product
                        Description*"></textarea></div>

                    </div>
                    <h4 class="title">Portfolio Cover Image</h4>
