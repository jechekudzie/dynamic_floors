        ...
        <div class="row justify-content-between align-items-center mb-10">
            ...
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-date-range">
                    <a style="margin:5px;" href="{{url('/admin/portfolios/create')}}" class="btn btn-success">Add new</a>
                    <a style="margin:5px;" href="{{url('/admin/portfolios/create')}}" class="btn btn-success">Back</a>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table data-table data-table-default table-vertical-middle ">
                        ...
                        @forelse($portfolios as $portfolio)
                            <tr>
                                <td>#MSP40022</td>
                                <td><img width="100" src="{{asset($portfolio->image)}}" alt=""
                                ...
                                <td>
                                    <div class="table-action-buttons">
                                        ...
                                        ('/admin/portfolios/'.$portfolio->id.'/edit')}}"><i
