        ...
        <div class="row justify-content-between align-items-center mb-10">
            ...
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-date-range">
                    <a style="margin:5px;" href="{{url('/admin/brands')}}" class="btn btn-success">Back</a>
                </div>
            </div>
        ...
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                <form action="{{url('/admin/brands/'.$brand->id)}}" method="post"
                    ...
                    @method('PATCH')
                    @csrf
                    <h4 class="title">Edit {{$brand->name}}</h4>

                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30"><input name="name" value="{{$brand->name}}"
                                                                  class="form-control" type="text"
                                                                  placeholder="Floor name*"></div>
                        <div class="col-12 mb-30"><textarea name="description" class="summernote form-control"
                                                            placeholder="Product
                        Description*">{{$brand->description}}</textarea></div>

                    </div>
                    <h4 class="current">Current cover image </h4>
                    <img style="width: 100px;" class="img-100" src="{{asset($brand->image)}}">
                    ...
                    <div class="row">
                        <div class="d-flex flex-wrap justify-content-end col mbn-10">
                            ...
                            <a href="{{url('/admin/brands')}}" class="button button-outline button-danger mb-10 ml-10
                            mr-0">Cancel</a>
                        </div>
