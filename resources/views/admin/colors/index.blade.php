        ...
        <div class="row justify-content-between align-items-center mb-10">
            ...
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-date-range">
                    <a style="margin:5px;" href="{{url('/admin/colors/create')}}" class="btn btn-success">Add new</a>
                    <a style="margin:5px;" href="{{url('/admin/colors/create')}}" class="btn btn-success">Back</a>
                </div>
            </div>
