    ...
    <div class="content-body">
        ...
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                <form action="{{url('/admin/floors/'.$floor->id)}}" method="post"
                      enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <h4 class="title">Edit {{$floor->name}}</h4>

                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30"><input name="name" value="{{$floor->name}}" class="form-control" type="text"
                                                                  placeholder="Floor name*"></div>
                        <div class="col-12 mb-30"><textarea name="description" class="summernote form-control"
                                                            placeholder="Product
                        Description*">{{$floor->description}}</textarea></div>

                    </div>
                    <h4 class="current">Current cover image </h4>
                    <img style="width: 100px;" class="img-100" src="{{asset($floor->image)}}">
                    ...
                    <div class="row">
                        <div class="d-flex flex-wrap justify-content-end col mbn-10">
                            ...
                            <a href="{{url('/admin/floors')}}" class="button button-outline button-danger mb-10 ml-10
                            mr-0">Cancel</a>
                        </div>
