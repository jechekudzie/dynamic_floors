    ...
    <div class="content-body">
        ...
        <div class="row justify-content-between align-items-center mb-10">
            ...
            <div class="col-12 col-lg-auto mb-20">
                <div class="page-heading">
                    <h3>Wall Decor - {{$wallDecor->type}}</h3>
                </div>
            </div>
            <!-- Page Heading End -->
        ...
        <div class="add-edit-product-wrap col-12">
            ...
            <div class="add-edit-product-form">
                <form action="{{url('/admin/wall_decor/'.$wallDecor->id)}}" method="post"
                      enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <h4 class="title">Edit {{$wallDecor->type}}</h4>

                    <div class="row">
                        <div class="col-lg-6 col-12 mb-30"><input name="type" value="{{$wallDecor->type}}" class="form-control" type="text"
                                                                  placeholder="Wall Decor Type*"></div>
                        <div class="col-12 mb-30"><textarea name="description" class="summernote form-control"
                                                            placeholder="Product
                        Description*">{{$wallDecor->description}}</textarea></div>

                    </div>
                    <h4 class="current">Current cover image </h4>
                    <img style="width: 100px;" class="img-100" src="{{asset($wallDecor->image)}}">
